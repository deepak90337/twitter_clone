...
function TweetBox() {
   ...
   // console.log("from tweetbox",email);
    ...
    const handleUploadImage = e => {
        ...
        axios.post("https://api.imgbb.com/1/upload?key=307bcac5140fa734ab32e3fc0d7b17e0", formData)
            .then(res => {
                setImageURL(res.data.data.display_url);
                // console.log("line 34 tweetbox",res.data.data.display_url);
                setIsLoading(false)
            })
            .catch((error) => {
                console.log(error);
    ...
    return <div className="tweetBox">
        <form onSubmit={handleTweet}>
            <div className="tweetBox__input">
                {/* {console.log("tweetbox.js line 88 ",loggedInUser[0]?.profileImage)} */}
